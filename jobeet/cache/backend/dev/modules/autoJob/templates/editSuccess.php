...
<div id="sf_admin_container">
  <h1><?php echo __('Editando el trabajo %%company%% que esta buscando un %%position%%', array('%%company%%' => $JobeetJob->getCompany(), '%%position%%' => $JobeetJob->getPosition()), 'messages') ?></h1>
